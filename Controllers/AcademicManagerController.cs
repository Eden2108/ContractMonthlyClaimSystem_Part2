...
namespace ContractMonthlyClaimSystem.Controllers
{
    public class AcademicManagerController : Controller
    {
        ...
        // Show verified claims from coordinators
        public IActionResult Index()
        {
            List<Claim> verifiedClaims = new List<Claim>();
            string query = "SELECT * FROM Claims WHERE claim_status = 'Verified by Coordinator'";
        ...
        {
            UpdateClaimStatus(id, "Approved by Manager");
        ...
        {
            UpdateClaimStatus(id, "Rejected by Manager");
            return RedirectToAction("Index");
        }
